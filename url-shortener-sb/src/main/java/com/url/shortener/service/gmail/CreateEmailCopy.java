...
public class CreateEmailCopy {
    ...
    public static MimeMessage createEmail(EmailRequest emailRequest) throws MessagingException{
            String toEmailAddress = emailRequest.getReceiverEmail();
            // String fromEmailAddress = emailRequest.getSenderEmail();
            String subject = emailRequest.getSubject();

            String resetLink =  emailRequest.getBody();
